...
function SquareToQuadrilateral({ customData }) {
    ...
    return (
        <div style={{ padding: '50px', fontFamily: 'Arial, sans-serif', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <svg width="400" height="400" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                {/* Quadrilateral */}
                <polygon points="100,100 300,80 250,250 80,200" stroke="black" strokeWidth="2" fill="yellow" />
                {/* Square */}
...
export default SquareToQuadrilateral;
