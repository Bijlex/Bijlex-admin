...
const DiagonalsSquare = ({ customData }) => {
  ...
  const distanceToSegment = (px, py, x1, y1, x2, y2) => {
    ...
    return Math.hypot(px - (x1 + t * (x2 - x1)), py - (y1 + t * (x2 - y1)));
  };
  ...
  const correctDiagonals = [
    [3 * CELL_SIZE, 3 * CELL_SIZE, 9 * CELL_SIZE, 9 * CELL_SIZE], // top-left to bottom-right of the square
    [9 * CELL_SIZE, 9 * CELL_SIZE, 3 * CELL_SIZE, 3 * CELL_SIZE], // bottom-right to top-left of the square
    [9 * CELL_SIZE, 3 * CELL_SIZE, 3 * CELL_SIZE, 9 * CELL_SIZE], // top-right to bottom-left of the square
    [3 * CELL_SIZE, 9 * CELL_SIZE, 9 * CELL_SIZE, 3 * CELL_SIZE]  // bottom-left to top-right of the square
  ];
...
export default DiagonalsSquare;
